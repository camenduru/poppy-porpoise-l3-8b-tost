...
RUN aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/Nitral-AI/Poppy_Porpoise-1.4-L3-8B/raw/main/config.json -d /content/model -o config.json && \
	...
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/Nitral-AI/Poppy_Porpoise-1.4-L3-8B/resolve/main/model-00001-of-00009.safetensors -d /content/model -o model-00001-of-00004.safetensors && \
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/Nitral-AI/Poppy_Porpoise-1.4-L3-8B/resolve/main/model-00002-of-00009.safetensors -d /content/model -o model-00002-of-00004.safetensors && \
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/Nitral-AI/Poppy_Porpoise-1.4-L3-8B/resolve/main/model-00003-of-00009.safetensors -d /content/model -o model-00003-of-00004.safetensors && \
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/Nitral-AI/Poppy_Porpoise-1.4-L3-8B/resolve/main/model-00004-of-00009.safetensors -d /content/model -o model-00004-of-00004.safetensors && \
